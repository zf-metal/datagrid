...
class GridCrudModal extends AbstractHelper {
    ...
    protected function getHtmlDelete(){
    ...
    public function __invoke($gridId) {
        ...
        $view .= 'function ' . \ZfMetal\Datagrid\C::F_DELETE . $gridId . '(objectId){'
                . '$("#zf-metal-grid-modal-content-' . $gridId . '").html("");'
                . ' var contentdelete = \'<div id="zf-metal-grid-delete-confirm-' . $gridId . '" class="alert alert-block alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <h4>Se require confirmación</h4>
                    <p>¿Esta seguro de eliminar el registro?</p>
                    <p>
                ...
                . '$("#zf-metal-grid-modal-content-' . $gridId . '").html(contentdelete);'
